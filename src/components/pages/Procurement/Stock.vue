  ...
  <div class="stock">
    ...
    <el-dialog title="添加信息" width="80%" :visible.sync="addVisible">
      <el-table :data="usedGoods" max-height="320" @selection-change="handleSelection">
        ...
        <el-table-column prop="goodsNo" label="编号" max-width="150" sortable> </el-table-column>
        <el-table-column prop="goodsName" label="品名" max-width="150" sortable> </el-table-column>
    ...
    <el-dialog title="查看订单详情" width="80%" :visible.sync="seeVisible">
      <el-table :data="stockInfo" border>
        ...
        <el-table-column label="药品编号" prop="goodsNo"></el-table-column>

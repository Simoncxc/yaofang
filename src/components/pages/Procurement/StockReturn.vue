  ...
  <div class="returnstock">
    ...
    <el-dialog width="1000px" :visible.sync="addVisible">
      <el-form :model="addForm" label-width="100px" :rules="rules" ref="addForm">
        <div class="top">
          <el-form-item label="药品编号" prop="goodsNo">
            <el-input v-model="addForm.goodsNo" @keydown.enter.native="handleGoodsKey" clearable placeholder="请输入药品编号"></el-input>
          </el-form-item>
          <el-form-item label="药品名称" prop="goodsName">
            <el-input v-model="addForm.goodsName" @keydown.enter.native="handleGoodsKey" clearable placeholder="请输入药品名"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="handleGoodsSearch">查询药品</el-button>
          </el-form-item>
        </div>
        ...
        <div class="bottom">
          ...
          <el-form-item label="价格:"  aria-placeholder="0.00">
